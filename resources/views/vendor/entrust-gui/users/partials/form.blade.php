...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="calle" placeholder="Nombre de la Calle" name="calle" value="" oninput="geolocalizar()">
</div>

<div class="form-group">
    <label for="puerta">Número de Puerta</label>
    <input type="text" class="form-control" id="nopuerta" placeholder="Número de Puerta" name="puerta" value="" oninput="geolocalizar()" >
</div>
